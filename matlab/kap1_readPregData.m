...
% but plots can be executed stand alone 
%
...
% save figures to figure directory if existing, use same directory
% otherwise
ppath = '..\bilder\';
if ~exist(ppath,'dir')
    ppath = '';
...
% contruct bar plot with 17, 18, ... 47 on the x-axis and frequencies of
